...
export enum ActionType {
    ...
    USER_ROLE_UPDATE_FAILED = 'USER_ROLE_UPDATE_FAILED',
    ...
    CITY_DELETE_FAILED = "CITY_DELETE_FAILED",
    CITY_UPDATE = "CITY_UPDATE",
    CITY_UPDATE_FAILED = "CITY_UPDATE_FAILED",
    CITY_RESTORE = "CITY_RESTORE",
    CITY_RESTORE_FAILED = "CITY_RESTORE_FAILED",
    PRICE_CREATE = "PRICE_CREATE",
    PRICE_CREATE_FAILED = "PRICE_CREATE_FAILED",
    PRICE_UPDATE = "PRICE_UPDATE",
    PRICE_UPDATE_FAILED = "PRICE_UPDATE_FAILED",
    LOCKER_OPEN_USER = "LOCKER_OPEN_USER",
    LOCKER_OPEN_USER_FAILED = "LOCKER_OPEN_USER_FAILED",
    LOCKER_CLOSE_USER = "LOCKER_CLOSE_USER",
    LOCKER_CLOSE_USER_FAILED = "LOCKER_CLOSE_USER_FAILED",
    LOCKER_CLOSE_OPERATOR = "LOCKER_CLOSE_OPERATOR",
    LOCKER_CLOSE_OPERATOR_FAILED = "LOCKER_CLOSE_OPERATOR_FAILED",
    LOCKER_OPEN_OPERATOR = "LOCKER_OPEN_OPERATOR",
    LOCKER_OPEN_OPERATOR_FAILED = "LOCKER_OPEN_OPERATOR_FAILED",
    USER_RESTORE = "USER_RESTORE",
    USER_RESTORE_FAILED = "USER_RESTORE_FAILED",
